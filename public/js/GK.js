...
function onRemovePlayer (data) {
    ...
    socket.emit('winbyquit',{id: socket.id});
        socket.emit('remove_fromlist_win_GK',{
        id:socket.id,
        room__id: room_id
    });
        ...
        function answer(ans){
            ...
            socket.on('lose',(data)=>{
                ...
                socket.emit('remove_fromlist_lose_GK',{
                    id:socket.id,
                    room__id : room_id
                });
            });
            socket.on('draw',(data)=>{
                ...
                socket.emit('remove_fromlist_draw_GK',{
                    id:socket.id,
                    room__id : room_id
                });
            });
  ...
  // socket connection
    ...
    // game
    socket.on('GK',gameplay);
     socket.on('GK_1',gameplay1);

      //listen to new enemy connections
      socket.on("new_enemyPlayer_GK", onNewPlayer);
