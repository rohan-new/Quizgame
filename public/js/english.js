...
function onRemovePlayer (data) {
    ...
    socket.emit('player_removed_english',{
        id: removePlayer,
        room__id: room_id
    });
    socket.emit('remove_fromlist_win_english',{
        id:socket.id,
        room__id: room_id
    });
...
socket.on('connect',function(){
  socket.emit('new_player_english',{
      id:socket.id 
  });
...
socket.on('enemy_scores',(data)=>{
  ...
  socket.on("new_enemyPlayer_english", onNewPlayer);
...
socket.on('lose',(data)=>{
    ...
    socket.emit('remove_fromlist_lose_english',{
        id:socket.id,
        room__id : room_id
    });
});
socket.on('draw',(data)=>{
    ...
    socket.emit('remove_fromlist_draw_english',{
        id:socket.id,
        room__id: room_id
    });
});
