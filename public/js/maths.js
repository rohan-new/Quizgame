...
socket.on('waiting',function(data){
    ...
    setTimeout(function(){
      ...
      document.getElementById('instructions').innerHTML = "You have 12 seconds to answer each question"
    },4000);
    setTimeout(function(){
